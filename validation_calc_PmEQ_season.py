...
if __name__ == '__main__':
    ...
    for ts in ts_list:    
        ...
        for i in [band_no]:   
            ...
            out_file = drght_dir + 'PmEQ_results/mean_seas_glm_probability_prob_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
            sel_prob_band_seas_mean.to_netcdf(out_file)
            ...
            out_file = drght_dir + 'PmEQ_results/hist_seas_prob_drought_break_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
