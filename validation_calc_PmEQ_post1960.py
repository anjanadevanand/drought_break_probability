...
if __name__ == '__main__':
    ...
    for ts in ts_list:    
        ...
        for i in [band_no]:   
            ...
            out_file = drght_dir + 'PmEQ_results/post1960_mean_glm_probability_prob_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
            ...
            out_file = drght_dir + 'PmEQ_results/post1960_hist_prob_drought_break_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
