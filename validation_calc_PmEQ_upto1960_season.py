...
if __name__ == '__main__':
    ...
    drght_time_slice = slice('1911-01-01', '1960-12-31')
    ...
    for ts in ts_list:    
        ...
        for i in [band_no]:   
            ...
            # out_file = drght_dir + 'PmEQ_results/upto1960_glm_probability_prob_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
            # sel_prob_band.to_netcdf(out_file)
            out_file = drght_dir + 'PmEQ_results/upto1960_mean_seas_glm_probability_prob_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
            ...
            out_file = drght_dir + 'PmEQ_results/upto1960_hist_seas_prob_drought_break_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
