...
if __name__ == '__main__':
    ...
    for ts in ts_list:    
        ...
        for i in [band_no]:   
            ...
            out_file = drght_dir + 'PmEQ_results_time_subset/glm_probability_prob_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
            sel_prob_band.to_netcdf(out_file)
            out_file = drght_dir + 'PmEQ_results_time_subset/mean_glm_probability_prob_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
            sel_prob_band.mean('time').to_netcdf(out_file)
            ...
            # out_file = drght_dir + 'PmEQ_results_time_subset/hist_prob_drought_break_band' + str(band_name[i]) + '.nc'
            ...
            out_file = drght_dir + 'PmEQ_results_time_subset/hist_prob_drought_break_band' + str(band_name[i]) + '_weeks' + str(ts) + '.nc'
